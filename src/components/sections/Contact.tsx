        ...
        >
          ...
          >
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white border border-noble-navy/10 rounded-full text-noble-navy hover:bg-noble-navy hover:text-white transition-all duration-300 shadow-sm hover:shadow-md"
            >
